...
public class BmpParse {
  ...
  private Hashtable infoMap = new Hashtable();
 ...
 public Image loadbitmap(Graphics2D graph) {
   ...
   try {
     ...
     int nsize = ( ( (int) bf[5] & 0xff) << 24)
         ...
         | ( ( (int) bf[3] & 0xff) << 8)
         | (int) bf[2] & 0xff;
     infoMap.put("size", new Integer(nsize));
     ...
     int nbisize = ( ( (int) bi[3] & 0xff) << 24)
         ...
         | ( ( (int) bi[1] & 0xff) << 8)
         | (int) bi[0] & 0xff;
     infoMap.put("bitmapinfoheader", new Integer(nbisize));
     ...
     int nwidth = ( ( (int) bi[7] & 0xff) << 24)
         ...
         | ( ( (int) bi[5] & 0xff) << 8)
         | (int) bi[4] & 0xff;
     infoMap.put("width", new Integer(nwidth));
     ...
     int nheight = ( ( (int) bi[11] & 0xff) << 24)
         ...
         | ( ( (int) bi[9] & 0xff) << 8)
         | (int) bi[8] & 0xff;
     infoMap.put("height", new Integer(nheight));
     //System.out.println("Height is :" + nheight);

     // number of planes in this bitmap
     int nplanes = ( ( (int) bi[13] & 0xff) << 8) | (int) bi[12] & 0xff;
     infoMap.put("planes", new Integer(nplanes));
     ...
     infoMap.put("bitCount", new Integer(nbitcount));
     ...
     int ncompression = ( ( (int) bi[19]) << 24)
         ...
         | ( ( (int) bi[17]) << 8)
         | (int) bi[16];
     infoMap.put("compression", new Integer(ncompression));
     ...
     int nsizeimage = ( ( (int) bi[23] & 0xff) << 24)
         ...
         | ( ( (int) bi[21] & 0xff) << 8)
         | (int) bi[20] & 0xff;
     infoMap.put("sizeImage", new Integer(nsizeimage));
     ...
     int nxpm = ( ( (int) bi[27] & 0xff) << 24)
         ...
         | ( ( (int) bi[25] & 0xff) << 8)
         | (int) bi[24] & 0xff;
     infoMap.put("x-Pixels", new Integer(nxpm));
     ...
     int nypm = ( ( (int) bi[31] & 0xff) << 24)
         ...
         | ( ( (int) bi[29] & 0xff) << 8)
         | (int) bi[28] & 0xff;
     infoMap.put("y-Pixels", new Integer(nypm));
     ...
     int nclrused = ( ( (int) bi[35] & 0xff) << 24)
         ...
         | ( ( (int) bi[33] & 0xff) << 8)
         | (int) bi[32] & 0xff;
     infoMap.put("colorsUsed", new Integer(nclrused));
     ...
     int nclrimp = ( ( (int) bi[39] & 0xff) << 24)
         ...
         | ( ( (int) bi[37] & 0xff) << 8)
         | (int) bi[36] & 0xff;
     infoMap.put("colorsImportant", new Integer(nclrimp));
     ...
     if (nsizeimage == 0) {
       ...
       nsizeimage *= nheight;
       infoMap.put("nsizeimageBackup", new Integer(nsizeimage));
...
/*           System.out.println("Encoded Color at ("
       ...
       infoMap.put("colorsNumber", new Integer(nNumColors));
...
/*         System.out.println("Palette Color " + n
       ...
       infoMap.put("nPad", new Integer(npad8));
 ...
 public static void main(String[] ages){
	 BmpParse bmpParse = new BmpParse("F://name//name.bmp");
	 BufferedImage img = new BufferedImage(200, 300,BufferedImage.TYPE_INT_RGB);
	 Image image = bmpParse.loadbitmap(null);
	 
	 
	 img.getGraphics().drawImage(
     		image.getScaledInstance(200, 300,Image.SCALE_SMOOTH), 0, 0, null
     		);
     try {
		ImageIO.write(img, "bmp", new File("F://name//test.bmp"));
		System.out.print(image.getHeight(null));
	} catch (IOException e) {
